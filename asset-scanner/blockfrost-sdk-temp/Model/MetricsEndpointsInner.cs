...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MetricsEndpointsInner :  IEquatable<MetricsEndpointsInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricsEndpointsInner" /> class.
        /// </summary>
        /// <param name="time">Starting time of the call count interval (ends midnight UTC) in UNIX time (required).</param>
        /// <param name="calls">Sum of all calls for a particular day and endpoint (required).</param>
        /// <param name="endpoint">Endpoint parent name (required).</param>
        public MetricsEndpointsInner(int? time = default(int?), int? calls = default(int?), string endpoint = default(string))
        {
            // to ensure "time" is required (not null)
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for MetricsEndpointsInner and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (calls == null)
            {
                throw new InvalidDataException("calls is a required property for MetricsEndpointsInner and cannot be null");
            }
            else
            {
                this.Calls = calls;
            ...
            if (endpoint == null)
            {
                throw new InvalidDataException("endpoint is a required property for MetricsEndpointsInner and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Starting time of the call count interval (ends midnight UTC) in UNIX time</value>
        ...
        /// </summary>
        /// <value>Sum of all calls for a particular day and endpoint</value>
        ...
        /// </summary>
        /// <value>Endpoint parent name</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MetricsEndpointsInner {\n");
        ...
        {
            return this.Equals(input as MetricsEndpointsInner);
        }

        /// <summary>
        /// Returns true if MetricsEndpointsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of MetricsEndpointsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetricsEndpointsInner input)
        {
            if (input == null)
                return false;
