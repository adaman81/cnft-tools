...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetPolicyInner :  IEquatable<AssetPolicyInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetPolicyInner" /> class.
        /// </summary>
        /// <param name="asset">Concatenation of the policy_id and hex-encoded asset_name (required).</param>
        /// <param name="quantity">Current asset quantity (required).</param>
        public AssetPolicyInner(string asset = default(string), string quantity = default(string))
        {
            // to ensure "asset" is required (not null)
            if (asset == null)
            {
                throw new InvalidDataException("asset is a required property for AssetPolicyInner and cannot be null");
            }
            else
            {
                this.Asset = asset;
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for AssetPolicyInner and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Concatenation of the policy_id and hex-encoded asset_name</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetPolicyInner {\n");
        ...
        {
            return this.Equals(input as AssetPolicyInner);
        }

        /// <summary>
        /// Returns true if AssetPolicyInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetPolicyInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetPolicyInner input)
        {
            if (input == null)
                return false;
