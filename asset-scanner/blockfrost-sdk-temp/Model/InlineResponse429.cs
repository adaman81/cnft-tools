...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponse429 :  IEquatable<InlineResponse429>
    {
        /// <summary>
        ...
        public InlineResponse429(int? statusCode = default(int?), string error = default(string), string message = default(string))
        {
            // to ensure "statusCode" is required (not null)
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for InlineResponse429 and cannot be null");
            }
            else
            {
            ...
            if (error == null)
            {
                throw new InvalidDataException("error is a required property for InlineResponse429 and cannot be null");
            }
            else
            {
                this.Error = error;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for InlineResponse429 and cannot be null");
            }
            else
            {
