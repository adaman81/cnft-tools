...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NutlinkAddressTickerInner :  IEquatable<NutlinkAddressTickerInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NutlinkAddressTickerInner" /> class.
        /// </summary>
        ...
        public NutlinkAddressTickerInner(string txHash = default(string), int? blockHeight = default(int?), int? txIndex = default(int?), AnyOfnutlinkAddressTickerInnerPayload payload = default(AnyOfnutlinkAddressTickerInnerPayload))
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for NutlinkAddressTickerInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            ...
            if (blockHeight == null)
            {
                throw new InvalidDataException("blockHeight is a required property for NutlinkAddressTickerInner and cannot be null");
            }
            else
            {
            ...
            if (txIndex == null)
            {
                throw new InvalidDataException("txIndex is a required property for NutlinkAddressTickerInner and cannot be null");
            }
            else
            {
            ...
            if (payload == null)
            {
                throw new InvalidDataException("payload is a required property for NutlinkAddressTickerInner and cannot be null");
            }
            else
            {
        ...
        public AnyOfnutlinkAddressTickerInnerPayload Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NutlinkAddressTickerInner {\n");
        ...
        {
            return this.Equals(input as NutlinkAddressTickerInner);
        }

        /// <summary>
        /// Returns true if NutlinkAddressTickerInner instances are equal
        /// </summary>
        /// <param name="input">Instance of NutlinkAddressTickerInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NutlinkAddressTickerInner input)
        {
            if (input == null)
                return false;
