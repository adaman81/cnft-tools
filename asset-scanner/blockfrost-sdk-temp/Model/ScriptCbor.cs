...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ScriptCbor :  IEquatable<ScriptCbor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScriptCbor" /> class.
        /// </summary>
        /// <param name="cbor">CBOR contents of the &#x60;plutus&#x60; script, null for &#x60;timelocks&#x60; (required).</param>
        public ScriptCbor(AnyOfscriptCborCbor cbor = default(AnyOfscriptCborCbor))
        {
            // to ensure "cbor" is required (not null)
            if (cbor == null)
            {
                throw new InvalidDataException("cbor is a required property for ScriptCbor and cannot be null");
            }
            else
            {
                this.Cbor = cbor;
        ...
        /// </summary>
        /// <value>CBOR contents of the &#x60;plutus&#x60; script, null for &#x60;timelocks&#x60;</value>
        [DataMember(Name="cbor", EmitDefaultValue=false)]
        public AnyOfscriptCborCbor Cbor { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScriptCbor {\n");
            sb.Append("  Cbor: ").Append(Cbor).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ScriptCbor);
        }

        /// <summary>
        /// Returns true if ScriptCbor instances are equal
        /// </summary>
        /// <param name="input">Instance of ScriptCbor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScriptCbor input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.Cbor == input.Cbor ||
                    (this.Cbor != null &&
                    this.Cbor.Equals(input.Cbor))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                int hashCode = 41;
                if (this.Cbor != null)
                    hashCode = hashCode * 59 + this.Cbor.GetHashCode();
                return hashCode;
            }
        }
    }
