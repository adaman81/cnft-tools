...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AnyOfscriptCborCbor :  IEquatable<AnyOfscriptCborCbor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOfscriptCborCbor" /> class.
        /// </summary>
        public AnyOfscriptCborCbor()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnyOfscriptCborCbor {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AnyOfscriptCborCbor);
        }

        /// <summary>
        /// Returns true if AnyOfscriptCborCbor instances are equal
        /// </summary>
        /// <param name="input">Instance of AnyOfscriptCborCbor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnyOfscriptCborCbor input)
        {
            if (input == null)
                return false;
