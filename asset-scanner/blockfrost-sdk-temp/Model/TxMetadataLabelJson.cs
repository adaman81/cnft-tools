...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxMetadataLabelJson : List<TxMetadataLabelJsonInner>,  IEquatable<TxMetadataLabelJson>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxMetadataLabelJson" /> class.
        /// </summary>
        public TxMetadataLabelJson() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxMetadataLabelJson {\n");
        ...
        {
            return this.Equals(input as TxMetadataLabelJson);
        }

        /// <summary>
        /// Returns true if TxMetadataLabelJson instances are equal
        /// </summary>
        /// <param name="input">Instance of TxMetadataLabelJson to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxMetadataLabelJson input)
        {
            if (input == null)
                return false;
