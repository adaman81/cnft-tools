...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountWithdrawalContentInner :  IEquatable<AccountWithdrawalContentInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountWithdrawalContentInner" /> class.
        /// </summary>
        /// <param name="txHash">Hash of the transaction containing the withdrawal (required).</param>
        /// <param name="amount">Withdrawal amount in Lovelaces (required).</param>
        public AccountWithdrawalContentInner(string txHash = default(string), string amount = default(string))
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for AccountWithdrawalContentInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for AccountWithdrawalContentInner and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        /// </summary>
        /// <value>Hash of the transaction containing the withdrawal</value>
        ...
        /// </summary>
        /// <value>Withdrawal amount in Lovelaces</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountWithdrawalContentInner {\n");
        ...
        {
            return this.Equals(input as AccountWithdrawalContentInner);
        }

        /// <summary>
        /// Returns true if AccountWithdrawalContentInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountWithdrawalContentInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountWithdrawalContentInner input)
        {
            if (input == null)
                return false;
