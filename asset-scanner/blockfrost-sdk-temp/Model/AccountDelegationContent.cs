...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountDelegationContent : List<AccountDelegationContentInner>,  IEquatable<AccountDelegationContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountDelegationContent" /> class.
        /// </summary>
        public AccountDelegationContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountDelegationContent {\n");
        ...
        {
            return this.Equals(input as AccountDelegationContent);
        }

        /// <summary>
        /// Returns true if AccountDelegationContent instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountDelegationContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountDelegationContent input)
        {
            if (input == null)
                return false;
