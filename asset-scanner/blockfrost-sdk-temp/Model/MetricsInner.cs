...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MetricsInner :  IEquatable<MetricsInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricsInner" /> class.
        /// </summary>
        /// <param name="time">Starting time of the call count interval (ends midnight UTC) in UNIX time (required).</param>
        /// <param name="calls">Sum of all calls for a particular day (required).</param>
        public MetricsInner(int? time = default(int?), int? calls = default(int?))
        {
            // to ensure "time" is required (not null)
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for MetricsInner and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (calls == null)
            {
                throw new InvalidDataException("calls is a required property for MetricsInner and cannot be null");
            }
            else
            {
                this.Calls = calls;
        ...
        /// </summary>
        /// <value>Sum of all calls for a particular day</value>
        ...
        {
            return this.Equals(input as MetricsInner);
        }

        /// <summary>
        /// Returns true if MetricsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of MetricsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetricsInner input)
        {
            if (input == null)
                return false;
