...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>
    {
        ...
        /// </summary>
        /// <value>State of the pin action</value>
        ...
        /// <param name="state">State of the pin action (required).</param>
        public InlineResponse2008(string ipfsHash = default(string), StateEnum state = default(StateEnum))
        {
            // to ensure "ipfsHash" is required (not null)
            if (ipfsHash == null)
            {
                throw new InvalidDataException("ipfsHash is a required property for InlineResponse2008 and cannot be null");
            }
            else
            {
            ...
            if (state == null)
            {
                throw new InvalidDataException("state is a required property for InlineResponse2008 and cannot be null");
            }
            else
            {
                this.State = state;
