...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountRewardContent : List<AccountRewardContentInner>,  IEquatable<AccountRewardContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountRewardContent" /> class.
        /// </summary>
        public AccountRewardContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountRewardContent {\n");
        ...
        {
            return this.Equals(input as AccountRewardContent);
        }

        /// <summary>
        /// Returns true if AccountRewardContent instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountRewardContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountRewardContent input)
        {
            if (input == null)
                return false;
