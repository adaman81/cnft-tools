...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentMetadata : List<TxContentMetadataInner>,  IEquatable<TxContentMetadata>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentMetadata" /> class.
        /// </summary>
        public TxContentMetadata() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxContentMetadata {\n");
        ...
        {
            return this.Equals(input as TxContentMetadata);
        }

        /// <summary>
        /// Returns true if TxContentMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentMetadata input)
        {
            if (input == null)
                return false;
