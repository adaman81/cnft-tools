...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AddressTransactionsContentInner :  IEquatable<AddressTransactionsContentInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressTransactionsContentInner" /> class.
        /// </summary>
        ...
        /// <param name="blockHeight">Block height (required).</param>
        public AddressTransactionsContentInner(string txHash = default(string), int? txIndex = default(int?), int? blockHeight = default(int?))
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for AddressTransactionsContentInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            ...
            if (txIndex == null)
            {
                throw new InvalidDataException("txIndex is a required property for AddressTransactionsContentInner and cannot be null");
            }
            else
            {
            ...
            if (blockHeight == null)
            {
                throw new InvalidDataException("blockHeight is a required property for AddressTransactionsContentInner and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressTransactionsContentInner {\n");
        ...
        {
            return this.Equals(input as AddressTransactionsContentInner);
        }

        /// <summary>
        /// Returns true if AddressTransactionsContentInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressTransactionsContentInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressTransactionsContentInner input)
        {
            if (input == null)
                return false;
