...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EpochContentArray : List<EpochContent>,  IEquatable<EpochContentArray>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochContentArray" /> class.
        /// </summary>
        public EpochContentArray() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EpochContentArray {\n");
        ...
        {
            return this.Equals(input as EpochContentArray);
        }

        /// <summary>
        /// Returns true if EpochContentArray instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochContentArray to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochContentArray input)
        {
            if (input == null)
                return false;
