...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentOutputAmount :  IEquatable<TxContentOutputAmount>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentOutputAmount" /> class.
        /// </summary>
        /// <param name="unit">The unit of the value (required).</param>
        /// <param name="quantity">The quantity of the unit (required).</param>
        public TxContentOutputAmount(string unit = default(string), string quantity = default(string))
        {
            // to ensure "unit" is required (not null)
            if (unit == null)
            {
                throw new InvalidDataException("unit is a required property for TxContentOutputAmount and cannot be null");
            }
            else
            {
                this.Unit = unit;
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for TxContentOutputAmount and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TxContentOutputAmount);
        }

        /// <summary>
        /// Returns true if TxContentOutputAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentOutputAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentOutputAmount input)
        {
            if (input == null)
                return false;
