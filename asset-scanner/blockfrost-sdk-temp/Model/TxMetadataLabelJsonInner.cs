...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxMetadataLabelJsonInner :  IEquatable<TxMetadataLabelJsonInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxMetadataLabelJsonInner" /> class.
        /// </summary>
        /// <param name="txHash">Transaction hash that contains the specific metadata (required).</param>
        /// <param name="jsonMetadata">Content of the JSON metadata (required).</param>
        public TxMetadataLabelJsonInner(string txHash = default(string), AnyOftxMetadataLabelJsonInnerJsonMetadata jsonMetadata = default(AnyOftxMetadataLabelJsonInnerJsonMetadata))
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for TxMetadataLabelJsonInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            }
            // to ensure "jsonMetadata" is required (not null)
            if (jsonMetadata == null)
            {
                throw new InvalidDataException("jsonMetadata is a required property for TxMetadataLabelJsonInner and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Content of the JSON metadata</value>
        [DataMember(Name="json_metadata", EmitDefaultValue=false)]
        public AnyOftxMetadataLabelJsonInnerJsonMetadata JsonMetadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxMetadataLabelJsonInner {\n");
        ...
        {
            return this.Equals(input as TxMetadataLabelJsonInner);
        }

        /// <summary>
        /// Returns true if TxMetadataLabelJsonInner instances are equal
        /// </summary>
        /// <param name="input">Instance of TxMetadataLabelJsonInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxMetadataLabelJsonInner input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.JsonMetadata == input.JsonMetadata ||
                    (this.JsonMetadata != null &&
                    this.JsonMetadata.Equals(input.JsonMetadata))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.JsonMetadata != null)
                    hashCode = hashCode * 59 + this.JsonMetadata.GetHashCode();
                return hashCode;
            }
        }
    }
