...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BlockContentTxs : List<string>,  IEquatable<BlockContentTxs>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockContentTxs" /> class.
        /// </summary>
        public BlockContentTxs() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BlockContentTxs {\n");
        ...
        {
            return this.Equals(input as BlockContentTxs);
        }

        /// <summary>
        /// Returns true if BlockContentTxs instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockContentTxs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockContentTxs input)
        {
            if (input == null)
                return false;
