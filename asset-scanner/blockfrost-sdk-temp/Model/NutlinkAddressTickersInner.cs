...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NutlinkAddressTickersInner :  IEquatable<NutlinkAddressTickersInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NutlinkAddressTickersInner" /> class.
        /// </summary>
        /// <param name="name">Name of the ticker (required).</param>
        /// <param name="count">Number of ticker records (required).</param>
        /// <param name="latestBlock">Block height of the latest record (required).</param>
        public NutlinkAddressTickersInner(string name = default(string), int? count = default(int?), int? latestBlock = default(int?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NutlinkAddressTickersInner and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for NutlinkAddressTickersInner and cannot be null");
            }
            else
            {
                this.Count = count;
            }
            // to ensure "latestBlock" is required (not null)
            if (latestBlock == null)
            {
                throw new InvalidDataException("latestBlock is a required property for NutlinkAddressTickersInner and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Number of ticker records</value>
        ...
        /// </summary>
        /// <value>Block height of the latest record</value>
        [DataMember(Name="latest_block", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NutlinkAddressTickersInner {\n");
        ...
        {
            return this.Equals(input as NutlinkAddressTickersInner);
        }

        /// <summary>
        /// Returns true if NutlinkAddressTickersInner instances are equal
        /// </summary>
        /// <param name="input">Instance of NutlinkAddressTickersInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NutlinkAddressTickersInner input)
        {
            if (input == null)
                return false;
