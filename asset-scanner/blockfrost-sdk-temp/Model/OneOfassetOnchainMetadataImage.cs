...
{
    /// <summary>
    /// OneOfassetOnchainMetadataImage
    /// </summary>
    [DataContract]
        public partial class OneOfassetOnchainMetadataImage :  IEquatable<OneOfassetOnchainMetadataImage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfassetOnchainMetadataImage" /> class.
        /// </summary>
        public OneOfassetOnchainMetadataImage()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfassetOnchainMetadataImage {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfassetOnchainMetadataImage);
        }

        /// <summary>
        /// Returns true if OneOfassetOnchainMetadataImage instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfassetOnchainMetadataImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfassetOnchainMetadataImage input)
        {
            if (input == null)
                return false;
