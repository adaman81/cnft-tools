...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentRedeemersInner :  IEquatable<TxContentRedeemersInner>
    {
        /// <summary>
        /// Validation purpose
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentRedeemersInner" /> class.
        /// </summary>
        /// <param name="txIndex">Index of the redeemer within the transaction (required).</param>
        /// <param name="purpose">Validation purpose (required).</param>
        /// <param name="scriptHash">Script hash (required).</param>
        ...
        public TxContentRedeemersInner(int? txIndex = default(int?), PurposeEnum purpose = default(PurposeEnum), string scriptHash = default(string), string datumHash = default(string), string unitMem = default(string), string unitSteps = default(string), string fee = default(string))
        {
            // to ensure "txIndex" is required (not null)
            if (txIndex == null)
            {
                throw new InvalidDataException("txIndex is a required property for TxContentRedeemersInner and cannot be null");
            }
            else
            {
            ...
            if (purpose == null)
            {
                throw new InvalidDataException("purpose is a required property for TxContentRedeemersInner and cannot be null");
            }
            else
            {
                this.Purpose = purpose;
            }
            // to ensure "scriptHash" is required (not null)
            if (scriptHash == null)
            {
                throw new InvalidDataException("scriptHash is a required property for TxContentRedeemersInner and cannot be null");
            }
            else
            {
            ...
            if (datumHash == null)
            {
                throw new InvalidDataException("datumHash is a required property for TxContentRedeemersInner and cannot be null");
            }
            else
            {
            ...
            if (unitMem == null)
            {
                throw new InvalidDataException("unitMem is a required property for TxContentRedeemersInner and cannot be null");
            }
            else
            {
            ...
            if (unitSteps == null)
            {
                throw new InvalidDataException("unitSteps is a required property for TxContentRedeemersInner and cannot be null");
            }
            else
            {
            ...
            if (fee == null)
            {
                throw new InvalidDataException("fee is a required property for TxContentRedeemersInner and cannot be null");
            }
            else
            {
                this.Fee = fee;
        ...
        /// </summary>
        /// <value>Index of the redeemer within the transaction</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxContentRedeemersInner {\n");
        ...
        {
            return this.Equals(input as TxContentRedeemersInner);
        }

        /// <summary>
        /// Returns true if TxContentRedeemersInner instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentRedeemersInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentRedeemersInner input)
        {
            if (input == null)
                return false;
