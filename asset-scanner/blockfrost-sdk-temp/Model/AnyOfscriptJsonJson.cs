...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AnyOfscriptJsonJson :  IEquatable<AnyOfscriptJsonJson>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOfscriptJsonJson" /> class.
        /// </summary>
        public AnyOfscriptJsonJson()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnyOfscriptJsonJson {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AnyOfscriptJsonJson);
        }

        /// <summary>
        /// Returns true if AnyOfscriptJsonJson instances are equal
        /// </summary>
        /// <param name="input">Instance of AnyOfscriptJsonJson to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnyOfscriptJsonJson input)
        {
            if (input == null)
                return false;
