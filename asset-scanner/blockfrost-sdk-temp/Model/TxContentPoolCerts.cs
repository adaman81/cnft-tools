...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentPoolCerts : List<TxContentPoolCertsInner>,  IEquatable<TxContentPoolCerts>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentPoolCerts" /> class.
        /// </summary>
        public TxContentPoolCerts() : base()
        {
        }
        ...
        {
            return this.Equals(input as TxContentPoolCerts);
        }

        /// <summary>
        /// Returns true if TxContentPoolCerts instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentPoolCerts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentPoolCerts input)
        {
            if (input == null)
                return false;
