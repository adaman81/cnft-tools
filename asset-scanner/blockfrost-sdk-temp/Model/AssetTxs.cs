...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetTxs : List<string>,  IEquatable<AssetTxs>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetTxs" /> class.
        /// </summary>
        public AssetTxs() : base()
        {
        }
        ...
        {
            return this.Equals(input as AssetTxs);
        }

        /// <summary>
        /// Returns true if AssetTxs instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetTxs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetTxs input)
        {
            if (input == null)
                return false;
