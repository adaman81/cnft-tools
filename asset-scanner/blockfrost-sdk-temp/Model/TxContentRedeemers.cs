...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentRedeemers : List<TxContentRedeemersInner>,  IEquatable<TxContentRedeemers>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentRedeemers" /> class.
        /// </summary>
        public TxContentRedeemers() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxContentRedeemers {\n");
        ...
        {
            return this.Equals(input as TxContentRedeemers);
        }

        /// <summary>
        /// Returns true if TxContentRedeemers instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentRedeemers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentRedeemers input)
        {
            if (input == null)
                return false;
