...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PoolBlocks : List<string>,  IEquatable<PoolBlocks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolBlocks" /> class.
        /// </summary>
        public PoolBlocks() : base()
        {
        }
        ...
        {
            return this.Equals(input as PoolBlocks);
        }

        /// <summary>
        /// Returns true if PoolBlocks instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolBlocks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolBlocks input)
        {
            if (input == null)
                return false;
