...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ScriptJson :  IEquatable<ScriptJson>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScriptJson" /> class.
        /// </summary>
        /// <param name="json">JSON contents of the &#x60;timelock&#x60; script, null for &#x60;plutus&#x60; scripts (required).</param>
        public ScriptJson(AnyOfscriptJsonJson json = default(AnyOfscriptJsonJson))
        {
            // to ensure "json" is required (not null)
            if (json == null)
            {
                throw new InvalidDataException("json is a required property for ScriptJson and cannot be null");
            }
            else
            {
                this.Json = json;
        ...
        /// </summary>
        /// <value>JSON contents of the &#x60;timelock&#x60; script, null for &#x60;plutus&#x60; scripts</value>
        [DataMember(Name="json", EmitDefaultValue=false)]
        public AnyOfscriptJsonJson Json { get; set; }
        ...
        {
            return this.Equals(input as ScriptJson);
        }

        /// <summary>
        /// Returns true if ScriptJson instances are equal
        /// </summary>
        /// <param name="input">Instance of ScriptJson to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScriptJson input)
        {
            if (input == null)
                return false;
