...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PoolListRetireInner :  IEquatable<PoolListRetireInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolListRetireInner" /> class.
        /// </summary>
        /// <param name="poolId">Bech32 encoded pool ID (required).</param>
        /// <param name="epoch">Retirement epoch number (required).</param>
        public PoolListRetireInner(string poolId = default(string), int? epoch = default(int?))
        {
            // to ensure "poolId" is required (not null)
            if (poolId == null)
            {
                throw new InvalidDataException("poolId is a required property for PoolListRetireInner and cannot be null");
            }
            else
            {
                this.PoolId = poolId;
            ...
            if (epoch == null)
            {
                throw new InvalidDataException("epoch is a required property for PoolListRetireInner and cannot be null");
            }
            else
            {
                this.Epoch = epoch;
        ...
        /// </summary>
        /// <value>Retirement epoch number</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PoolListRetireInner {\n");
        ...
        {
            return this.Equals(input as PoolListRetireInner);
        }

        /// <summary>
        /// Returns true if PoolListRetireInner instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolListRetireInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolListRetireInner input)
        {
            if (input == null)
                return false;
