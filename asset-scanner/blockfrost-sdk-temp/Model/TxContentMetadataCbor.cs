...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentMetadataCbor : List<TxContentMetadataCborInner>,  IEquatable<TxContentMetadataCbor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentMetadataCbor" /> class.
        /// </summary>
        public TxContentMetadataCbor() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxContentMetadataCbor {\n");
        ...
        {
            return this.Equals(input as TxContentMetadataCbor);
        }

        /// <summary>
        /// Returns true if TxContentMetadataCbor instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentMetadataCbor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentMetadataCbor input)
        {
            if (input == null)
                return false;
