...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetPolicy : List<AssetPolicyInner>,  IEquatable<AssetPolicy>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetPolicy" /> class.
        /// </summary>
        public AssetPolicy() : base()
        {
        }
        ...
        {
            return this.Equals(input as AssetPolicy);
        }

        /// <summary>
        /// Returns true if AssetPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetPolicy input)
        {
            if (input == null)
                return false;
