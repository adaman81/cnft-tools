...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetHistoryInner :  IEquatable<AssetHistoryInner>
    {
        /// <summary>
        /// Action executed upon the asset policy
        /// </summary>
        /// <value>Action executed upon the asset policy</value>
        [JsonConverter(typeof(StringEnumConverter))]
                public enum ActionEnum
        {
            /// <summary>
            /// Enum Minted for value: minted
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetHistoryInner" /> class.
        /// </summary>
        /// <param name="txHash">Hash of the transaction containing the asset action (required).</param>
        /// <param name="action">Action executed upon the asset policy (required).</param>
        /// <param name="amount">Asset amount of the specific action (required).</param>
        public AssetHistoryInner(string txHash = default(string), ActionEnum action = default(ActionEnum), string amount = default(string))
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for AssetHistoryInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            ...
            if (action == null)
            {
                throw new InvalidDataException("action is a required property for AssetHistoryInner and cannot be null");
            }
            else
            {
                this.Action = action;
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for AssetHistoryInner and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        /// </summary>
        /// <value>Hash of the transaction containing the asset action</value>
        ...
        /// </summary>
        /// <value>Asset amount of the specific action</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetHistoryInner {\n");
        ...
        {
            return this.Equals(input as AssetHistoryInner);
        }

        /// <summary>
        /// Returns true if AssetHistoryInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetHistoryInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetHistoryInner input)
        {
            if (input == null)
                return false;
