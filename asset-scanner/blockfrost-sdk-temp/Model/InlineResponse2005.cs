...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>
    {
        ...
        public InlineResponse2005(string ipfsHash = default(string), StateEnum state = default(StateEnum))
        {
            // to ensure "ipfsHash" is required (not null)
            if (ipfsHash == null)
            {
                throw new InvalidDataException("ipfsHash is a required property for InlineResponse2005 and cannot be null");
            }
            else
            {
