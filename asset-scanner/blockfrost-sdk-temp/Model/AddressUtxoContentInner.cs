...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AddressUtxoContentInner :  IEquatable<AddressUtxoContentInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressUtxoContentInner" /> class.
        /// </summary>
        /// <param name="txHash">Transaction hash of the UTXO (required).</param>
        /// <param name="txIndex">UTXO index in the transaction (required).</param>
        /// <param name="outputIndex">UTXO index in the transaction (required).</param>
        /// <param name="amount">amount (required).</param>
        /// <param name="block">Block hash of the UTXO (required).</param>
        /// <param name="dataHash">The hash of the transaction output datum (required).</param>
        public AddressUtxoContentInner(string txHash = default(string), int? txIndex = default(int?), int? outputIndex = default(int?), List<Object> amount = default(List<Object>), string block = default(string), string dataHash = default(string))
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for AddressUtxoContentInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            ...
            if (txIndex == null)
            {
                throw new InvalidDataException("txIndex is a required property for AddressUtxoContentInner and cannot be null");
            }
            else
            {
            ...
            if (outputIndex == null)
            {
                throw new InvalidDataException("outputIndex is a required property for AddressUtxoContentInner and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for AddressUtxoContentInner and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (block == null)
            {
                throw new InvalidDataException("block is a required property for AddressUtxoContentInner and cannot be null");
            }
            else
            {
                this.Block = block;
            ...
            if (dataHash == null)
            {
                throw new InvalidDataException("dataHash is a required property for AddressUtxoContentInner and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Transaction hash of the UTXO</value>
        ...
        /// </summary>
        /// <value>Block hash of the UTXO</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressUtxoContentInner {\n");
        ...
        {
            return this.Equals(input as AddressUtxoContentInner);
        }

        /// <summary>
        /// Returns true if AddressUtxoContentInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressUtxoContentInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressUtxoContentInner input)
        {
            if (input == null)
                return false;
