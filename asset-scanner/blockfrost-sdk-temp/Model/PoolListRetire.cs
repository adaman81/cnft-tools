...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PoolListRetire : List<PoolListRetireInner>,  IEquatable<PoolListRetire>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolListRetire" /> class.
        /// </summary>
        public PoolListRetire() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PoolListRetire {\n");
        ...
        {
            return this.Equals(input as PoolListRetire);
        }

        /// <summary>
        /// Returns true if PoolListRetire instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolListRetire to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolListRetire input)
        {
            if (input == null)
                return false;
