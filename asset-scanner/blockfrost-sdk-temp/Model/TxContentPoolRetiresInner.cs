...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentPoolRetiresInner :  IEquatable<TxContentPoolRetiresInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentPoolRetiresInner" /> class.
        /// </summary>
        /// <param name="certIndex">Index of the certificate within the transaction (required).</param>
        /// <param name="poolId">Bech32 stake pool ID (required).</param>
        /// <param name="retiringEpoch">Retiring epoch (required).</param>
        public TxContentPoolRetiresInner(int? certIndex = default(int?), string poolId = default(string), int? retiringEpoch = default(int?))
        {
            // to ensure "certIndex" is required (not null)
            if (certIndex == null)
            {
                throw new InvalidDataException("certIndex is a required property for TxContentPoolRetiresInner and cannot be null");
            }
            else
            {
            ...
            if (poolId == null)
            {
                throw new InvalidDataException("poolId is a required property for TxContentPoolRetiresInner and cannot be null");
            }
            else
            {
                this.PoolId = poolId;
            }
            // to ensure "retiringEpoch" is required (not null)
            if (retiringEpoch == null)
            {
                throw new InvalidDataException("retiringEpoch is a required property for TxContentPoolRetiresInner and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Bech32 stake pool ID</value>
        ...
        /// Retiring epoch
        /// </summary>
        /// <value>Retiring epoch</value>
        [DataMember(Name="retiring_epoch", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxContentPoolRetiresInner {\n");
            sb.Append("  CertIndex: ").Append(CertIndex).Append("\n");
            sb.Append("  PoolId: ").Append(PoolId).Append("\n");
            sb.Append("  RetiringEpoch: ").Append(RetiringEpoch).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TxContentPoolRetiresInner);
        }

        /// <summary>
        /// Returns true if TxContentPoolRetiresInner instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentPoolRetiresInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentPoolRetiresInner input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RetiringEpoch == input.RetiringEpoch ||
                    (this.RetiringEpoch != null &&
                    this.RetiringEpoch.Equals(input.RetiringEpoch))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RetiringEpoch != null)
                    hashCode = hashCode * 59 + this.RetiringEpoch.GetHashCode();
                return hashCode;
            }
        }
    }
