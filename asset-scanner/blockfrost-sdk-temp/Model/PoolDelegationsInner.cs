...
{
    /// <summary>
    /// PoolDelegationsInner
    /// </summary>
    [DataContract]
        public partial class PoolDelegationsInner :  IEquatable<PoolDelegationsInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolDelegationsInner" /> class.
        /// </summary>
        /// <param name="txHash">Transaction ID (required).</param>
        /// <param name="certIndex">Certificate within the transaction (required).</param>
        public PoolDelegationsInner(string txHash = default(string), int? certIndex = default(int?))
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for PoolDelegationsInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            ...
            if (certIndex == null)
            {
                throw new InvalidDataException("certIndex is a required property for PoolDelegationsInner and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PoolDelegationsInner {\n");
        ...
        {
            return this.Equals(input as PoolDelegationsInner);
        }

        /// <summary>
        /// Returns true if PoolDelegationsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolDelegationsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolDelegationsInner input)
        {
            if (input == null)
                return false;
