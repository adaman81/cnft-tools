...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NutlinkAddressTicker : List<NutlinkAddressTickerInner>,  IEquatable<NutlinkAddressTicker>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NutlinkAddressTicker" /> class.
        /// </summary>
        public NutlinkAddressTicker() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NutlinkAddressTicker {\n");
        ...
        {
            return this.Equals(input as NutlinkAddressTicker);
        }

        /// <summary>
        /// Returns true if NutlinkAddressTicker instances are equal
        /// </summary>
        /// <param name="input">Instance of NutlinkAddressTicker to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NutlinkAddressTicker input)
        {
            if (input == null)
                return false;
