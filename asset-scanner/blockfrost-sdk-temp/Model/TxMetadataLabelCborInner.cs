...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxMetadataLabelCborInner :  IEquatable<TxMetadataLabelCborInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxMetadataLabelCborInner" /> class.
        /// </summary>
        /// <param name="txHash">Transaction hash that contains the specific metadata (required).</param>
        /// <param name="cborMetadata">Content of the CBOR metadata (required).</param>
        /// <param name="metadata">Content of the CBOR metadata in hex (required).</param>
        public TxMetadataLabelCborInner(string txHash = default(string), string cborMetadata = default(string), string metadata = default(string))
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for TxMetadataLabelCborInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            }
            // to ensure "cborMetadata" is required (not null)
            if (cborMetadata == null)
            {
                throw new InvalidDataException("cborMetadata is a required property for TxMetadataLabelCborInner and cannot be null");
            }
            else
            {
                this.CborMetadata = cborMetadata;
            }
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new InvalidDataException("metadata is a required property for TxMetadataLabelCborInner and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Transaction hash that contains the specific metadata</value>
        ...
        /// </summary>
        /// <value>Content of the CBOR metadata</value>
        [DataMember(Name="cbor_metadata", EmitDefaultValue=false)]
        public string CborMetadata { get; set; }

        /// <summary>
        /// Content of the CBOR metadata in hex
        /// </summary>
        /// <value>Content of the CBOR metadata in hex</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxMetadataLabelCborInner {\n");
            sb.Append("  TxHash: ").Append(TxHash).Append("\n");
            sb.Append("  CborMetadata: ").Append(CborMetadata).Append("\n");
        ...
        {
            return this.Equals(input as TxMetadataLabelCborInner);
        }

        /// <summary>
        /// Returns true if TxMetadataLabelCborInner instances are equal
        /// </summary>
        /// <param name="input">Instance of TxMetadataLabelCborInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxMetadataLabelCborInner input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CborMetadata == input.CborMetadata ||
                    (this.CborMetadata != null &&
                    this.CborMetadata.Equals(input.CborMetadata))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CborMetadata != null)
                    hashCode = hashCode * 59 + this.CborMetadata.GetHashCode();
