...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountAddressesAssets : List<AccountAddressesAssetsInner>,  IEquatable<AccountAddressesAssets>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAddressesAssets" /> class.
        /// </summary>
        public AccountAddressesAssets() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountAddressesAssets {\n");
        ...
        {
            return this.Equals(input as AccountAddressesAssets);
        }

        /// <summary>
        /// Returns true if AccountAddressesAssets instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountAddressesAssets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountAddressesAssets input)
        {
            if (input == null)
                return false;
