...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>
    {
        ...
        public InlineResponse2002(long? serverTime = default(long?))
        {
            // to ensure "serverTime" is required (not null)
            if (serverTime == null)
            {
                throw new InvalidDataException("serverTime is a required property for InlineResponse2002 and cannot be null");
            }
            else
            {
