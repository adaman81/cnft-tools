...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ScriptRedeemers : List<ScriptRedeemersInner>,  IEquatable<ScriptRedeemers>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScriptRedeemers" /> class.
        /// </summary>
        public ScriptRedeemers() : base()
        {
        }
        ...
        {
            return this.Equals(input as ScriptRedeemers);
        }

        /// <summary>
        /// Returns true if ScriptRedeemers instances are equal
        /// </summary>
        /// <param name="input">Instance of ScriptRedeemers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScriptRedeemers input)
        {
            if (input == null)
                return false;
