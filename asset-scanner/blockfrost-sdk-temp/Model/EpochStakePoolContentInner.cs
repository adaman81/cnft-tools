...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EpochStakePoolContentInner :  IEquatable<EpochStakePoolContentInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochStakePoolContentInner" /> class.
        /// </summary>
        ...
        public EpochStakePoolContentInner(string stakeAddress = default(string), string amount = default(string))
        {
            // to ensure "stakeAddress" is required (not null)
            if (stakeAddress == null)
            {
                throw new InvalidDataException("stakeAddress is a required property for EpochStakePoolContentInner and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for EpochStakePoolContentInner and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EpochStakePoolContentInner {\n");
        ...
        {
            return this.Equals(input as EpochStakePoolContentInner);
        }

        /// <summary>
        /// Returns true if EpochStakePoolContentInner instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochStakePoolContentInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochStakePoolContentInner input)
        {
            if (input == null)
                return false;
