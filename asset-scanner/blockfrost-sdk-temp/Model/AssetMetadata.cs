...
namespace IO.Swagger.Model
{
        ...
        public partial class AssetMetadata :  IEquatable<AssetMetadata>
    {
        ...
        /// </summary>
        /// <param name="name">Asset name (required).</param>
        /// <param name="description">Asset description (required).</param>
        /// <param name="ticker">ticker (required).</param>
        /// <param name="url">Asset website (required).</param>
        /// <param name="logo">Base64 encoded logo of the asset (required).</param>
        /// <param name="decimals">Number of decimal places of the asset unit (required).</param>
        public AssetMetadata(string name = default(string), string description = default(string), string ticker = default(string), string url = default(string), string logo = default(string), int? decimals = default(int?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AssetMetadata and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for AssetMetadata and cannot be null");
            }
            else
            {
            ...
            if (ticker == null)
            {
                throw new InvalidDataException("ticker is a required property for AssetMetadata and cannot be null");
            }
            else
            {
                this.Ticker = ticker;
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for AssetMetadata and cannot be null");
            }
            else
            {
                this.Url = url;
            ...
            if (logo == null)
            {
                throw new InvalidDataException("logo is a required property for AssetMetadata and cannot be null");
            }
            else
            {
                this.Logo = logo;
            ...
            if (decimals == null)
            {
                throw new InvalidDataException("decimals is a required property for AssetMetadata and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Base64 encoded logo of the asset</value>
        ...
        /// </summary>
        /// <value>Number of decimal places of the asset unit</value>
