...
{
    /// <summary>
    /// AnyOfscriptDatumJsonValue
    /// </summary>
    [DataContract]
        public partial class AnyOfscriptDatumJsonValue :  IEquatable<AnyOfscriptDatumJsonValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOfscriptDatumJsonValue" /> class.
        /// </summary>
        public AnyOfscriptDatumJsonValue()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnyOfscriptDatumJsonValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AnyOfscriptDatumJsonValue);
        }

        /// <summary>
        /// Returns true if AnyOfscriptDatumJsonValue instances are equal
        /// </summary>
        /// <param name="input">Instance of AnyOfscriptDatumJsonValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnyOfscriptDatumJsonValue input)
        {
            if (input == null)
                return false;
