...
namespace IO.Swagger.Model
{
        ...
        public partial class Script :  IEquatable<Script>
    {
        ...
        /// </summary>
        /// <value>Type of the script language</value>
        [JsonConverter(typeof(StringEnumConverter))]
                public enum TypeEnum
        {
            /// <summary>
            /// Enum Timelock for value: timelock
            /// </summary>
            [EnumMember(Value = "timelock")]
            Timelock = 1,
            /// <summary>
            /// Enum Plutus for value: plutus
            /// </summary>
            [EnumMember(Value = "plutus")]
            Plutus = 2        }
        /// <summary>
        /// Type of the script language
        /// </summary>
        ...
        /// <param name="type">Type of the script language (required).</param>
        /// <param name="serialisedSize">The size of the CBOR serialised script, if a Plutus script (required).</param>
        public Script(string scriptHash = default(string), TypeEnum type = default(TypeEnum), int? serialisedSize = default(int?))
        {
            // to ensure "scriptHash" is required (not null)
            if (scriptHash == null)
            {
                throw new InvalidDataException("scriptHash is a required property for Script and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Script and cannot be null");
            }
            else
            {
                this.Type = type;
            }
            // to ensure "serialisedSize" is required (not null)
            if (serialisedSize == null)
            {
                throw new InvalidDataException("serialisedSize is a required property for Script and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The size of the CBOR serialised script, if a Plutus script</value>
        [DataMember(Name="serialised_size", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SerialisedSize: ").Append(SerialisedSize).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Script input)
        {
            ...
            return 
                ...
                (
                    this.SerialisedSize == input.SerialisedSize ||
                    (this.SerialisedSize != null &&
                    this.SerialisedSize.Equals(input.SerialisedSize))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SerialisedSize != null)
                    hashCode = hashCode * 59 + this.SerialisedSize.GetHashCode();
                return hashCode;
            }
        }
    }
