...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetsInner :  IEquatable<AssetsInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetsInner" /> class.
        /// </summary>
        /// <param name="asset">Asset identifier (required).</param>
        /// <param name="quantity">Current asset quantity (required).</param>
        public AssetsInner(string asset = default(string), string quantity = default(string))
        {
            // to ensure "asset" is required (not null)
            if (asset == null)
            {
                throw new InvalidDataException("asset is a required property for AssetsInner and cannot be null");
            }
            else
            {
                this.Asset = asset;
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for AssetsInner and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AssetsInner);
        }

        /// <summary>
        /// Returns true if AssetsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetsInner input)
        {
            if (input == null)
                return false;
