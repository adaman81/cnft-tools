...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse400 :  IEquatable<InlineResponse400>
    {
        ...
        public InlineResponse400(int? statusCode = default(int?), string error = default(string), string message = default(string))
        {
            // to ensure "statusCode" is required (not null)
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for InlineResponse400 and cannot be null");
            }
            else
            {
