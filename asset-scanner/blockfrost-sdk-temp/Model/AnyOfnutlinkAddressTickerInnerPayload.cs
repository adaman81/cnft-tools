...
{
    /// <summary>
    /// AnyOfnutlinkAddressTickerInnerPayload
    /// </summary>
    [DataContract]
        public partial class AnyOfnutlinkAddressTickerInnerPayload :  IEquatable<AnyOfnutlinkAddressTickerInnerPayload>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOfnutlinkAddressTickerInnerPayload" /> class.
        /// </summary>
        public AnyOfnutlinkAddressTickerInnerPayload()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnyOfnutlinkAddressTickerInnerPayload {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AnyOfnutlinkAddressTickerInnerPayload);
        }

        /// <summary>
        /// Returns true if AnyOfnutlinkAddressTickerInnerPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of AnyOfnutlinkAddressTickerInnerPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnyOfnutlinkAddressTickerInnerPayload input)
        {
            if (input == null)
                return false;
