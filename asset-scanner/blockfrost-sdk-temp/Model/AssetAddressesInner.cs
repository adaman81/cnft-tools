...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetAddressesInner :  IEquatable<AssetAddressesInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetAddressesInner" /> class.
        /// </summary>
        /// <param name="address">Address containing the specific asset (required).</param>
        /// <param name="quantity">Asset quantity on the specific address (required).</param>
        public AssetAddressesInner(string address = default(string), string quantity = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new InvalidDataException("address is a required property for AssetAddressesInner and cannot be null");
            }
            else
            {
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for AssetAddressesInner and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Address containing the specific asset</value>
        ...
        /// </summary>
        /// <value>Asset quantity on the specific address</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetAddressesInner {\n");
        ...
        {
            return this.Equals(input as AssetAddressesInner);
        }

        /// <summary>
        /// Returns true if AssetAddressesInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetAddressesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetAddressesInner input)
        {
            if (input == null)
                return false;
