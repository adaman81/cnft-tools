...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentWithdrawals : List<TxContentWithdrawalsInner>,  IEquatable<TxContentWithdrawals>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentWithdrawals" /> class.
        /// </summary>
        public TxContentWithdrawals() : base()
        {
        }
        ...
        {
            return this.Equals(input as TxContentWithdrawals);
        }

        /// <summary>
        /// Returns true if TxContentWithdrawals instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentWithdrawals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentWithdrawals input)
        {
            if (input == null)
                return false;
