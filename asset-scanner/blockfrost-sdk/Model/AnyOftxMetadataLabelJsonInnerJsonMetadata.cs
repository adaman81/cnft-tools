...
{
    /// <summary>
    /// AnyOftxMetadataLabelJsonInnerJsonMetadata
    /// </summary>
    [DataContract]
        public partial class AnyOftxMetadataLabelJsonInnerJsonMetadata :  IEquatable<AnyOftxMetadataLabelJsonInnerJsonMetadata>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOftxMetadataLabelJsonInnerJsonMetadata" /> class.
        /// </summary>
        public AnyOftxMetadataLabelJsonInnerJsonMetadata()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnyOftxMetadataLabelJsonInnerJsonMetadata {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AnyOftxMetadataLabelJsonInnerJsonMetadata);
        }

        /// <summary>
        /// Returns true if AnyOftxMetadataLabelJsonInnerJsonMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of AnyOftxMetadataLabelJsonInnerJsonMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnyOftxMetadataLabelJsonInnerJsonMetadata input)
        {
            if (input == null)
                return false;
