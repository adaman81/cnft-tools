...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EpochStakeContentInner :  IEquatable<EpochStakeContentInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochStakeContentInner" /> class.
        /// </summary>
        /// <param name="stakeAddress">Stake address (required).</param>
        /// <param name="poolId">Bech32 prefix of the pool delegated to (required).</param>
        /// <param name="amount">Amount of active delegated stake in Lovelaces (required).</param>
        public EpochStakeContentInner(string stakeAddress = default(string), string poolId = default(string), string amount = default(string))
        {
            // to ensure "stakeAddress" is required (not null)
            if (stakeAddress == null)
            {
                throw new InvalidDataException("stakeAddress is a required property for EpochStakeContentInner and cannot be null");
            }
            else
            {
            ...
            if (poolId == null)
            {
                throw new InvalidDataException("poolId is a required property for EpochStakeContentInner and cannot be null");
            }
            else
            {
                this.PoolId = poolId;
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for EpochStakeContentInner and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        /// </summary>
        /// <value>Bech32 prefix of the pool delegated to</value>
        ...
        /// </summary>
        /// <value>Amount of active delegated stake in Lovelaces</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EpochStakeContentInner {\n");
        ...
        {
            return this.Equals(input as EpochStakeContentInner);
        }

        /// <summary>
        /// Returns true if EpochStakeContentInner instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochStakeContentInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochStakeContentInner input)
        {
            if (input == null)
                return false;
