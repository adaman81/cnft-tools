...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PoolUpdatesInner :  IEquatable<PoolUpdatesInner>
    {
        /// <summary>
                ...
                public enum ActionEnum
        {
            ...
            Registered = 1,
            /// <summary>
            /// Enum Deregistered for value: deregistered
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolUpdatesInner" /> class.
        /// </summary>
        /// <param name="txHash">Transaction ID (required).</param>
        /// <param name="certIndex">Certificate within the transaction (required).</param>
        /// <param name="action">Action in the certificate (required).</param>
        public PoolUpdatesInner(string txHash = default(string), int? certIndex = default(int?), ActionEnum action = default(ActionEnum))
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for PoolUpdatesInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            ...
            if (certIndex == null)
            {
                throw new InvalidDataException("certIndex is a required property for PoolUpdatesInner and cannot be null");
            }
            else
            {
            ...
            if (action == null)
            {
                throw new InvalidDataException("action is a required property for PoolUpdatesInner and cannot be null");
            }
            else
            {
                this.Action = action;
        ...
        /// </summary>
        /// <value>Certificate within the transaction</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PoolUpdatesInner {\n");
        ...
        {
            return this.Equals(input as PoolUpdatesInner);
        }

        /// <summary>
        /// Returns true if PoolUpdatesInner instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolUpdatesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolUpdatesInner input)
        {
            if (input == null)
                return false;
