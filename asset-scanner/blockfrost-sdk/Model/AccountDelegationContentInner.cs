...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountDelegationContentInner :  IEquatable<AccountDelegationContentInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountDelegationContentInner" /> class.
        /// </summary>
        /// <param name="activeEpoch">Epoch in which the delegation becomes active (required).</param>
        /// <param name="txHash">Hash of the transaction containing the delegation (required).</param>
        /// <param name="amount">Rewards for given epoch in Lovelaces (required).</param>
        /// <param name="poolId">Bech32 ID of pool being delegated to (required).</param>
        public AccountDelegationContentInner(int? activeEpoch = default(int?), string txHash = default(string), string amount = default(string), string poolId = default(string))
        {
            // to ensure "activeEpoch" is required (not null)
            if (activeEpoch == null)
            {
                throw new InvalidDataException("activeEpoch is a required property for AccountDelegationContentInner and cannot be null");
            }
            else
            {
            ...
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for AccountDelegationContentInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for AccountDelegationContentInner and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (poolId == null)
            {
                throw new InvalidDataException("poolId is a required property for AccountDelegationContentInner and cannot be null");
            }
            else
            {
                this.PoolId = poolId;
        ...
        /// </summary>
        /// <value>Hash of the transaction containing the delegation</value>
        ...
        /// </summary>
        /// <value>Bech32 ID of pool being delegated to</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountDelegationContentInner {\n");
        ...
        {
            return this.Equals(input as AccountDelegationContentInner);
        }

        /// <summary>
        /// Returns true if AccountDelegationContentInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountDelegationContentInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountDelegationContentInner input)
        {
            if (input == null)
                return false;
