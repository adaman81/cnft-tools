...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetAddresses : List<AssetAddressesInner>,  IEquatable<AssetAddresses>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetAddresses" /> class.
        /// </summary>
        public AssetAddresses() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetAddresses {\n");
        ...
        {
            return this.Equals(input as AssetAddresses);
        }

        /// <summary>
        /// Returns true if AssetAddresses instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetAddresses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetAddresses input)
        {
            if (input == null)
                return false;
