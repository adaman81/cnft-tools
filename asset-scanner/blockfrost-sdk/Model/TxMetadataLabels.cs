...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxMetadataLabels : List<TxMetadataLabelsInner>,  IEquatable<TxMetadataLabels>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxMetadataLabels" /> class.
        /// </summary>
        public TxMetadataLabels() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxMetadataLabels {\n");
        ...
        {
            return this.Equals(input as TxMetadataLabels);
        }

        /// <summary>
        /// Returns true if TxMetadataLabels instances are equal
        /// </summary>
        /// <param name="input">Instance of TxMetadataLabels to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxMetadataLabels input)
        {
            if (input == null)
                return false;
