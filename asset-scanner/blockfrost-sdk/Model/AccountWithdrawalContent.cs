...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountWithdrawalContent : List<AccountWithdrawalContentInner>,  IEquatable<AccountWithdrawalContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountWithdrawalContent" /> class.
        /// </summary>
        public AccountWithdrawalContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountWithdrawalContent {\n");
        ...
        {
            return this.Equals(input as AccountWithdrawalContent);
        }

        /// <summary>
        /// Returns true if AccountWithdrawalContent instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountWithdrawalContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountWithdrawalContent input)
        {
            if (input == null)
                return false;
