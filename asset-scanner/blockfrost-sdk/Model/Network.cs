...
namespace blockfrost.Model
{
        ...
        public partial class Network :  IEquatable<Network>
    {
        ...
        public Network(NetworkSupply supply = default(NetworkSupply), NetworkStake stake = default(NetworkStake))
        {
            // to ensure "supply" is required (not null)
            if (supply == null)
            {
                throw new InvalidDataException("supply is a required property for Network and cannot be null");
            }
            else
            {
                this.Supply = supply;
            ...
            if (stake == null)
            {
                throw new InvalidDataException("stake is a required property for Network and cannot be null");
            }
            else
            {
                this.Stake = stake;
        ...
        public NetworkSupply Supply { get; set; }

        /// <summary>
        /// Gets or Sets Stake
        /// </summary>
        [DataMember(Name="stake", EmitDefaultValue=false)]
        public NetworkStake Stake { get; set; }
