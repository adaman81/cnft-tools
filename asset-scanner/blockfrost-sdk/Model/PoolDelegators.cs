...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PoolDelegators : List<PoolDelegatorsInner>,  IEquatable<PoolDelegators>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolDelegators" /> class.
        /// </summary>
        public PoolDelegators() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PoolDelegators {\n");
        ...
        {
            return this.Equals(input as PoolDelegators);
        }

        /// <summary>
        /// Returns true if PoolDelegators instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolDelegators to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolDelegators input)
        {
            if (input == null)
                return false;
