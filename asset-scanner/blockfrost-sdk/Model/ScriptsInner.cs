...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ScriptsInner :  IEquatable<ScriptsInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScriptsInner" /> class.
        /// </summary>
        /// <param name="scriptHash">Script hash (required).</param>
        public ScriptsInner(string scriptHash = default(string))
        {
            // to ensure "scriptHash" is required (not null)
            if (scriptHash == null)
            {
                throw new InvalidDataException("scriptHash is a required property for ScriptsInner and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ScriptsInner);
        }

        /// <summary>
        /// Returns true if ScriptsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ScriptsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScriptsInner input)
        {
            if (input == null)
                return false;
