...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NetworkStake :  IEquatable<NetworkStake>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkStake" /> class.
        /// </summary>
        /// <param name="live">Current live stake in Lovelaces (required).</param>
        /// <param name="active">Current active stake in Lovelaces (required).</param>
        public NetworkStake(string live = default(string), string active = default(string))
        {
            // to ensure "live" is required (not null)
            if (live == null)
            {
                throw new InvalidDataException("live is a required property for NetworkStake and cannot be null");
            }
            else
            {
                this.Live = live;
            ...
            if (active == null)
            {
                throw new InvalidDataException("active is a required property for NetworkStake and cannot be null");
            }
            else
            {
                this.Active = active;
        ...
        /// </summary>
        /// <value>Current live stake in Lovelaces</value>
        ...
        /// </summary>
        /// <value>Current active stake in Lovelaces</value>
        ...
        {
            return this.Equals(input as NetworkStake);
        }

        /// <summary>
        /// Returns true if NetworkStake instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkStake to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkStake input)
        {
            if (input == null)
                return false;
