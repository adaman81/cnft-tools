...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ScriptDatum :  IEquatable<ScriptDatum>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScriptDatum" /> class.
        /// </summary>
        /// <param name="jsonValue">JSON content of the datum (required).</param>
        public ScriptDatum(AnyOfscriptDatumJsonValue jsonValue = default(AnyOfscriptDatumJsonValue))
        {
            // to ensure "jsonValue" is required (not null)
            if (jsonValue == null)
            {
                throw new InvalidDataException("jsonValue is a required property for ScriptDatum and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>JSON content of the datum</value>
        [DataMember(Name="json_value", EmitDefaultValue=false)]
        public AnyOfscriptDatumJsonValue JsonValue { get; set; }
        ...
        {
            return this.Equals(input as ScriptDatum);
        }

        /// <summary>
        /// Returns true if ScriptDatum instances are equal
        /// </summary>
        /// <param name="input">Instance of ScriptDatum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScriptDatum input)
        {
            if (input == null)
                return false;
