...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountAddressesContentInner :  IEquatable<AccountAddressesContentInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAddressesContentInner" /> class.
        /// </summary>
        /// <param name="address">Address associated with the stake key (required).</param>
        public AccountAddressesContentInner(string address = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new InvalidDataException("address is a required property for AccountAddressesContentInner and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Address associated with the stake key</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountAddressesContentInner {\n");
        ...
        {
            return this.Equals(input as AccountAddressesContentInner);
        }

        /// <summary>
        /// Returns true if AccountAddressesContentInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountAddressesContentInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountAddressesContentInner input)
        {
            if (input == null)
                return false;
