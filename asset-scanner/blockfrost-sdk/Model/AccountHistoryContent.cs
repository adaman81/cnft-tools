...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountHistoryContent : List<AccountHistoryContentInner>,  IEquatable<AccountHistoryContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHistoryContent" /> class.
        /// </summary>
        public AccountHistoryContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountHistoryContent {\n");
        ...
        {
            return this.Equals(input as AccountHistoryContent);
        }

        /// <summary>
        /// Returns true if AccountHistoryContent instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountHistoryContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountHistoryContent input)
        {
            if (input == null)
                return false;
