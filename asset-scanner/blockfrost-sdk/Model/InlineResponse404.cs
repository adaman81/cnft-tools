...
namespace blockfrost.Model
{
        ...
        public partial class InlineResponse404 :  IEquatable<InlineResponse404>
    {
        ...
        public InlineResponse404(int? statusCode = default(int?), string error = default(string), string message = default(string))
        {
            // to ensure "statusCode" is required (not null)
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for InlineResponse404 and cannot be null");
            }
            else
            {
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for InlineResponse404 and cannot be null");
            }
            else
            {
