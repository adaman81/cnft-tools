...
{
    /// <summary>
    /// OneOftxContentMetadataInnerJsonMetadata
    /// </summary>
    [DataContract]
        public partial class OneOftxContentMetadataInnerJsonMetadata :  IEquatable<OneOftxContentMetadataInnerJsonMetadata>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOftxContentMetadataInnerJsonMetadata" /> class.
        /// </summary>
        public OneOftxContentMetadataInnerJsonMetadata()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOftxContentMetadataInnerJsonMetadata {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOftxContentMetadataInnerJsonMetadata);
        }

        /// <summary>
        /// Returns true if OneOftxContentMetadataInnerJsonMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOftxContentMetadataInnerJsonMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOftxContentMetadataInnerJsonMetadata input)
        {
            if (input == null)
                return false;
