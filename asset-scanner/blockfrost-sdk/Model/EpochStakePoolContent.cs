...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EpochStakePoolContent : List<EpochStakePoolContentInner>,  IEquatable<EpochStakePoolContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochStakePoolContent" /> class.
        /// </summary>
        public EpochStakePoolContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EpochStakePoolContent {\n");
        ...
        {
            return this.Equals(input as EpochStakePoolContent);
        }

        /// <summary>
        /// Returns true if EpochStakePoolContent instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochStakePoolContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochStakePoolContent input)
        {
            if (input == null)
                return false;
