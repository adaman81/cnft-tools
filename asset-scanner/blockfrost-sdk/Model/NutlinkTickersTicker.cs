...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NutlinkTickersTicker : List<NutlinkTickersTickerInner>,  IEquatable<NutlinkTickersTicker>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NutlinkTickersTicker" /> class.
        /// </summary>
        public NutlinkTickersTicker() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NutlinkTickersTicker {\n");
        ...
        {
            return this.Equals(input as NutlinkTickersTicker);
        }

        /// <summary>
        /// Returns true if NutlinkTickersTicker instances are equal
        /// </summary>
        /// <param name="input">Instance of NutlinkTickersTicker to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NutlinkTickersTicker input)
        {
            if (input == null)
                return false;
