...
{
    /// <summary>
    /// AnyOfnutlinkTickersTickerInnerPayload
    /// </summary>
    [DataContract]
        public partial class AnyOfnutlinkTickersTickerInnerPayload :  IEquatable<AnyOfnutlinkTickersTickerInnerPayload>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOfnutlinkTickersTickerInnerPayload" /> class.
        /// </summary>
        public AnyOfnutlinkTickersTickerInnerPayload()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnyOfnutlinkTickersTickerInnerPayload {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AnyOfnutlinkTickersTickerInnerPayload);
        }

        /// <summary>
        /// Returns true if AnyOfnutlinkTickersTickerInnerPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of AnyOfnutlinkTickersTickerInnerPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnyOfnutlinkTickersTickerInnerPayload input)
        {
            if (input == null)
                return false;
