...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PoolHistory : List<PoolHistoryInner>,  IEquatable<PoolHistory>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolHistory" /> class.
        /// </summary>
        public PoolHistory() : base()
        {
        }
        ...
        {
            return this.Equals(input as PoolHistory);
        }

        /// <summary>
        /// Returns true if PoolHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolHistory input)
        {
            if (input == null)
                return false;
