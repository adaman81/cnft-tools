...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentStakeAddr : List<TxContentStakeAddrInner>,  IEquatable<TxContentStakeAddr>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentStakeAddr" /> class.
        /// </summary>
        public TxContentStakeAddr() : base()
        {
        }
        ...
        {
            return this.Equals(input as TxContentStakeAddr);
        }

        /// <summary>
        /// Returns true if TxContentStakeAddr instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentStakeAddr to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentStakeAddr input)
        {
            if (input == null)
                return false;
