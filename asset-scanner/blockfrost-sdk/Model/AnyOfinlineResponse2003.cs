...
{
    /// <summary>
    /// AnyOfinlineResponse2003
    /// </summary>
    [DataContract]
        public partial class AnyOfinlineResponse2003 :  IEquatable<AnyOfinlineResponse2003>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOfinlineResponse2003" /> class.
        /// </summary>
        public AnyOfinlineResponse2003()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnyOfinlineResponse2003 {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AnyOfinlineResponse2003);
        }

        /// <summary>
        /// Returns true if AnyOfinlineResponse2003 instances are equal
        /// </summary>
        /// <param name="input">Instance of AnyOfinlineResponse2003 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnyOfinlineResponse2003 input)
        {
            if (input == null)
                return false;
