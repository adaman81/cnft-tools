...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NutlinkAddressTickers : List<NutlinkAddressTickersInner>,  IEquatable<NutlinkAddressTickers>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NutlinkAddressTickers" /> class.
        /// </summary>
        public NutlinkAddressTickers() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NutlinkAddressTickers {\n");
        ...
        {
            return this.Equals(input as NutlinkAddressTickers);
        }

        /// <summary>
        /// Returns true if NutlinkAddressTickers instances are equal
        /// </summary>
        /// <param name="input">Instance of NutlinkAddressTickers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NutlinkAddressTickers input)
        {
            if (input == null)
                return false;
