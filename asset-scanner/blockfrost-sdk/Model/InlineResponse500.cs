...
namespace blockfrost.Model
{
        ...
        public partial class InlineResponse500 :  IEquatable<InlineResponse500>
    {
        ...
        public InlineResponse500(int? statusCode = default(int?), string error = default(string), string message = default(string))
        {
            // to ensure "statusCode" is required (not null)
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for InlineResponse500 and cannot be null");
            }
            else
            {
