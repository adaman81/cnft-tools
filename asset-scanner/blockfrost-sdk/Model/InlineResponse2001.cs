...
namespace blockfrost.Model
{
        ...
        public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>
    {
        ...
        /// </summary>
        /// <param name="isHealthy">isHealthy (required).</param>
        public InlineResponse2001(bool? isHealthy = default(bool?))
        {
            // to ensure "isHealthy" is required (not null)
            if (isHealthy == null)
            {
                throw new InvalidDataException("isHealthy is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="is_healthy", EmitDefaultValue=false)]
