...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountMirContent : List<AccountMirContentInner>,  IEquatable<AccountMirContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountMirContent" /> class.
        /// </summary>
        public AccountMirContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountMirContent {\n");
        ...
        {
            return this.Equals(input as AccountMirContent);
        }

        /// <summary>
        /// Returns true if AccountMirContent instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountMirContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountMirContent input)
        {
            if (input == null)
                return false;
