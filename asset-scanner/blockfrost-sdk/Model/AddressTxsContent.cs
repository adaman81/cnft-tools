...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AddressTxsContent : List<string>,  IEquatable<AddressTxsContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressTxsContent" /> class.
        /// </summary>
        public AddressTxsContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressTxsContent {\n");
        ...
        {
            return this.Equals(input as AddressTxsContent);
        }

        /// <summary>
        /// Returns true if AddressTxsContent instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressTxsContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressTxsContent input)
        {
            if (input == null)
                return false;
