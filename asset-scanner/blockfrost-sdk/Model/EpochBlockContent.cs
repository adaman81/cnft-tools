...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EpochBlockContent : List<string>,  IEquatable<EpochBlockContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochBlockContent" /> class.
        /// </summary>
        public EpochBlockContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EpochBlockContent {\n");
        ...
        {
            return this.Equals(input as EpochBlockContent);
        }

        /// <summary>
        /// Returns true if EpochBlockContent instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochBlockContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochBlockContent input)
        {
            if (input == null)
                return false;
