...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EpochStakeContent : List<EpochStakeContentInner>,  IEquatable<EpochStakeContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochStakeContent" /> class.
        /// </summary>
        public EpochStakeContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EpochStakeContent {\n");
        ...
        {
            return this.Equals(input as EpochStakeContent);
        }

        /// <summary>
        /// Returns true if EpochStakeContent instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochStakeContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochStakeContent input)
        {
            if (input == null)
                return false;
