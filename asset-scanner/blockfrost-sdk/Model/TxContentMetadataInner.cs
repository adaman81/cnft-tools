...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentMetadataInner :  IEquatable<TxContentMetadataInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentMetadataInner" /> class.
        /// </summary>
        /// <param name="label">Metadata label (required).</param>
        /// <param name="jsonMetadata">Content of the metadata (required).</param>
        public TxContentMetadataInner(string label = default(string), OneOftxContentMetadataInnerJsonMetadata jsonMetadata = default(OneOftxContentMetadataInnerJsonMetadata))
        {
            // to ensure "label" is required (not null)
            if (label == null)
            {
                throw new InvalidDataException("label is a required property for TxContentMetadataInner and cannot be null");
            }
            else
            {
                this.Label = label;
            ...
            {
                throw new InvalidDataException("jsonMetadata is a required property for TxContentMetadataInner and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Content of the metadata</value>
        [DataMember(Name="json_metadata", EmitDefaultValue=false)]
        public OneOftxContentMetadataInnerJsonMetadata JsonMetadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxContentMetadataInner {\n");
        ...
        {
            return this.Equals(input as TxContentMetadataInner);
        }

        /// <summary>
        /// Returns true if TxContentMetadataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentMetadataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentMetadataInner input)
        {
            if (input == null)
                return false;
