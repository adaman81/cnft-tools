...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PoolDelegations : List<PoolDelegationsInner>,  IEquatable<PoolDelegations>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolDelegations" /> class.
        /// </summary>
        public PoolDelegations() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PoolDelegations {\n");
        ...
        {
            return this.Equals(input as PoolDelegations);
        }

        /// <summary>
        /// Returns true if PoolDelegations instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolDelegations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolDelegations input)
        {
            if (input == null)
                return false;
