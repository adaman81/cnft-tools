...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountRegistrationContent : List<AccountRegistrationContentInner>,  IEquatable<AccountRegistrationContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountRegistrationContent" /> class.
        /// </summary>
        public AccountRegistrationContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountRegistrationContent {\n");
        ...
        {
            return this.Equals(input as AccountRegistrationContent);
        }

        /// <summary>
        /// Returns true if AccountRegistrationContent instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountRegistrationContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountRegistrationContent input)
        {
            if (input == null)
                return false;
