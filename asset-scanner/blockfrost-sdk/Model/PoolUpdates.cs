...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PoolUpdates : List<PoolUpdatesInner>,  IEquatable<PoolUpdates>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolUpdates" /> class.
        /// </summary>
        public PoolUpdates() : base()
        {
        }
        ...
        {
            return this.Equals(input as PoolUpdates);
        }

        /// <summary>
        /// Returns true if PoolUpdates instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolUpdates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolUpdates input)
        {
            if (input == null)
                return false;
