...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MetricsEndpoints : List<MetricsEndpointsInner>,  IEquatable<MetricsEndpoints>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricsEndpoints" /> class.
        /// </summary>
        public MetricsEndpoints() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MetricsEndpoints {\n");
        ...
        {
            return this.Equals(input as MetricsEndpoints);
        }

        /// <summary>
        /// Returns true if MetricsEndpoints instances are equal
        /// </summary>
        /// <param name="input">Instance of MetricsEndpoints to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetricsEndpoints input)
        {
            if (input == null)
                return false;
