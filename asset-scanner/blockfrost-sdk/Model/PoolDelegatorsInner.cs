...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PoolDelegatorsInner :  IEquatable<PoolDelegatorsInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolDelegatorsInner" /> class.
        /// </summary>
        /// <param name="address">Bech32 encoded stake addresses (required).</param>
        /// <param name="liveStake">Currently delegated amount (required).</param>
        public PoolDelegatorsInner(string address = default(string), string liveStake = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new InvalidDataException("address is a required property for PoolDelegatorsInner and cannot be null");
            }
            else
            {
            ...
            if (liveStake == null)
            {
                throw new InvalidDataException("liveStake is a required property for PoolDelegatorsInner and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Bech32 encoded stake addresses</value>
        ...
        /// </summary>
        /// <value>Currently delegated amount</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PoolDelegatorsInner {\n");
        ...
        {
            return this.Equals(input as PoolDelegatorsInner);
        }

        /// <summary>
        /// Returns true if PoolDelegatorsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolDelegatorsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolDelegatorsInner input)
        {
            if (input == null)
                return false;
