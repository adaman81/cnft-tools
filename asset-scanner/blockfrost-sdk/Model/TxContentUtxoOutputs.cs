...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentUtxoOutputs :  IEquatable<TxContentUtxoOutputs>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentUtxoOutputs" /> class.
        /// </summary>
        /// <param name="address">Output address (required).</param>
        ...
        public TxContentUtxoOutputs(string address = default(string), List<TxContentOutputAmount> amount = default(List<TxContentOutputAmount>), int? outputIndex = default(int?), string dataHash = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new InvalidDataException("address is a required property for TxContentUtxoOutputs and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for TxContentUtxoOutputs and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (outputIndex == null)
            {
                throw new InvalidDataException("outputIndex is a required property for TxContentUtxoOutputs and cannot be null");
            }
            else
            {
            ...
            if (dataHash == null)
            {
                throw new InvalidDataException("dataHash is a required property for TxContentUtxoOutputs and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TxContentUtxoOutputs);
        }

        /// <summary>
        /// Returns true if TxContentUtxoOutputs instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentUtxoOutputs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentUtxoOutputs input)
        {
            if (input == null)
                return false;
