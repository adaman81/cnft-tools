...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentMirs : List<TxContentMirsInner>,  IEquatable<TxContentMirs>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentMirs" /> class.
        /// </summary>
        public TxContentMirs() : base()
        {
        }
        ...
        {
            return this.Equals(input as TxContentMirs);
        }

        /// <summary>
        /// Returns true if TxContentMirs instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentMirs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentMirs input)
        {
            if (input == null)
                return false;
