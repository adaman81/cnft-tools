...
namespace blockfrost.Model
{
        ...
        public partial class AccountRegistrationContentInner :  IEquatable<AccountRegistrationContentInner>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountRegistrationContentInner" /> class.
        /// </summary>
        /// <param name="txHash">Hash of the transaction containing the (de)registration certificate (required).</param>
        /// <param name="action">Action in the certificate (required).</param>
        public AccountRegistrationContentInner(string txHash = default(string), ActionEnum action = default(ActionEnum))
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for AccountRegistrationContentInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            ...
            if (action == null)
            {
                throw new InvalidDataException("action is a required property for AccountRegistrationContentInner and cannot be null");
            }
            else
            {
                this.Action = action;
        ...
        /// </summary>
        /// <value>Hash of the transaction containing the (de)registration certificate</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountRegistrationContentInner {\n");
        ...
        {
            return this.Equals(input as AccountRegistrationContentInner);
        }

        /// <summary>
        /// Returns true if AccountRegistrationContentInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountRegistrationContentInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountRegistrationContentInner input)
        {
            if (input == null)
                return false;
