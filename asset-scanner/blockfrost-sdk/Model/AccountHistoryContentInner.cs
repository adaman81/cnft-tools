...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountHistoryContentInner :  IEquatable<AccountHistoryContentInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHistoryContentInner" /> class.
        /// </summary>
        /// <param name="activeEpoch">Epoch in which the stake was active (required).</param>
        /// <param name="amount">Stake amount in Lovelaces (required).</param>
        /// <param name="poolId">Bech32 ID of pool being delegated to (required).</param>
        public AccountHistoryContentInner(int? activeEpoch = default(int?), string amount = default(string), string poolId = default(string))
        {
            // to ensure "activeEpoch" is required (not null)
            if (activeEpoch == null)
            {
                throw new InvalidDataException("activeEpoch is a required property for AccountHistoryContentInner and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for AccountHistoryContentInner and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (poolId == null)
            {
                throw new InvalidDataException("poolId is a required property for AccountHistoryContentInner and cannot be null");
            }
            else
            {
                this.PoolId = poolId;
        ...
        /// </summary>
        /// <value>Epoch in which the stake was active</value>
        ...
        /// </summary>
        /// <value>Stake amount in Lovelaces</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountHistoryContentInner {\n");
        ...
        {
            return this.Equals(input as AccountHistoryContentInner);
        }

        /// <summary>
        /// Returns true if AccountHistoryContentInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountHistoryContentInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountHistoryContentInner input)
        {
            if (input == null)
                return false;
