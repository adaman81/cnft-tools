...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountAddressesContent : List<AccountAddressesContentInner>,  IEquatable<AccountAddressesContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAddressesContent" /> class.
        /// </summary>
        public AccountAddressesContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountAddressesContent {\n");
        ...
        {
            return this.Equals(input as AccountAddressesContent);
        }

        /// <summary>
        /// Returns true if AccountAddressesContent instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountAddressesContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountAddressesContent input)
        {
            if (input == null)
                return false;
