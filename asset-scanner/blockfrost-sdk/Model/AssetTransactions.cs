...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetTransactions : List<AddressTransactionsContentInner>,  IEquatable<AssetTransactions>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetTransactions" /> class.
        /// </summary>
        public AssetTransactions() : base()
        {
        }
        ...
        {
            return this.Equals(input as AssetTransactions);
        }

        /// <summary>
        /// Returns true if AssetTransactions instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetTransactions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetTransactions input)
        {
            if (input == null)
                return false;
