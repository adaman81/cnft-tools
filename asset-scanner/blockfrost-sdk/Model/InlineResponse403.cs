...
namespace blockfrost.Model
{
        ...
        public partial class InlineResponse403 :  IEquatable<InlineResponse403>
    {
        ...
        public InlineResponse403(int? statusCode = default(int?), string error = default(string), string message = default(string))
        {
            // to ensure "statusCode" is required (not null)
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for InlineResponse403 and cannot be null");
            }
            else
            {
            ...
            if (error == null)
            {
                throw new InvalidDataException("error is a required property for InlineResponse403 and cannot be null");
            }
            else
            {
                this.Error = error;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for InlineResponse403 and cannot be null");
            }
            else
            {
