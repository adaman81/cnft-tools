...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BlockContentArray : List<BlockContent>,  IEquatable<BlockContentArray>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockContentArray" /> class.
        /// </summary>
        public BlockContentArray() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BlockContentArray {\n");
        ...
        {
            return this.Equals(input as BlockContentArray);
        }

        /// <summary>
        /// Returns true if BlockContentArray instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockContentArray to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockContentArray input)
        {
            if (input == null)
                return false;
