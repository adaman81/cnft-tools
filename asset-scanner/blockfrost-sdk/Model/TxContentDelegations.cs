...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentDelegations : List<TxContentDelegationsInner>,  IEquatable<TxContentDelegations>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentDelegations" /> class.
        /// </summary>
        public TxContentDelegations() : base()
        {
        }
        ...
        {
            return this.Equals(input as TxContentDelegations);
        }

        /// <summary>
        /// Returns true if TxContentDelegations instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentDelegations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentDelegations input)
        {
            if (input == null)
                return false;
