...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponse418 :  IEquatable<InlineResponse418>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse418" /> class.
        /// </summary>
        /// <param name="statusCode">statusCode (required).</param>
        /// <param name="error">error (required).</param>
        /// <param name="message">message (required).</param>
        public InlineResponse418(int? statusCode = default(int?), string error = default(string), string message = default(string))
        {
            // to ensure "statusCode" is required (not null)
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for InlineResponse418 and cannot be null");
            }
            else
            {
            ...
            if (error == null)
            {
                throw new InvalidDataException("error is a required property for InlineResponse418 and cannot be null");
            }
            else
            {
                this.Error = error;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for InlineResponse418 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as InlineResponse418);
        }

        /// <summary>
        /// Returns true if InlineResponse418 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse418 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse418 input)
        {
            if (input == null)
                return false;
