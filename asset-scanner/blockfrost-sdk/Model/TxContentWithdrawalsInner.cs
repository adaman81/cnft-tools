...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentWithdrawalsInner :  IEquatable<TxContentWithdrawalsInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentWithdrawalsInner" /> class.
        /// </summary>
        /// <param name="address">Bech32 withdrawal address (required).</param>
        /// <param name="amount">Withdrawal amount in Lovelaces (required).</param>
        public TxContentWithdrawalsInner(string address = default(string), string amount = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new InvalidDataException("address is a required property for TxContentWithdrawalsInner and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for TxContentWithdrawalsInner and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        /// </summary>
        /// <value>Bech32 withdrawal address</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxContentWithdrawalsInner {\n");
        ...
        {
            return this.Equals(input as TxContentWithdrawalsInner);
        }

        /// <summary>
        /// Returns true if TxContentWithdrawalsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentWithdrawalsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentWithdrawalsInner input)
        {
            if (input == null)
                return false;
