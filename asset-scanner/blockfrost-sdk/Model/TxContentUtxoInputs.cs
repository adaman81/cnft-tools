...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentUtxoInputs :  IEquatable<TxContentUtxoInputs>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentUtxoInputs" /> class.
        /// </summary>
        /// <param name="address">Input address (required).</param>
        /// <param name="amount">amount (required).</param>
        /// <param name="txHash">Hash of the UTXO transaction (required).</param>
        /// <param name="outputIndex">UTXO index in the transaction (required).</param>
        /// <param name="dataHash">The hash of the transaction output datum (required).</param>
        /// <param name="collateral">Whether the input is a collateral consumed on script validation failure (required).</param>
        public TxContentUtxoInputs(string address = default(string), List<TxContentOutputAmount> amount = default(List<TxContentOutputAmount>), string txHash = default(string), int? outputIndex = default(int?), string dataHash = default(string), bool? collateral = default(bool?))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new InvalidDataException("address is a required property for TxContentUtxoInputs and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for TxContentUtxoInputs and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for TxContentUtxoInputs and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            ...
            if (outputIndex == null)
            {
                throw new InvalidDataException("outputIndex is a required property for TxContentUtxoInputs and cannot be null");
            }
            else
            {
            ...
            if (dataHash == null)
            {
                throw new InvalidDataException("dataHash is a required property for TxContentUtxoInputs and cannot be null");
            }
            else
            {
                this.DataHash = dataHash;
            }
            // to ensure "collateral" is required (not null)
            if (collateral == null)
            {
                throw new InvalidDataException("collateral is a required property for TxContentUtxoInputs and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Hash of the UTXO transaction</value>
        ...
        /// </summary>
        /// <value>UTXO index in the transaction</value>
        ...
        /// </summary>
        /// <value>The hash of the transaction output datum</value>
        ...
        /// </summary>
        /// <value>Whether the input is a collateral consumed on script validation failure</value>
        ...
        {
            return this.Equals(input as TxContentUtxoInputs);
        }

        /// <summary>
        /// Returns true if TxContentUtxoInputs instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentUtxoInputs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentUtxoInputs input)
        {
            if (input == null)
                return false;
