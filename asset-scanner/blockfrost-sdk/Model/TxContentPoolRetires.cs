...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxContentPoolRetires : List<TxContentPoolRetiresInner>,  IEquatable<TxContentPoolRetires>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxContentPoolRetires" /> class.
        /// </summary>
        public TxContentPoolRetires() : base()
        {
        }
        ...
        {
            return this.Equals(input as TxContentPoolRetires);
        }

        /// <summary>
        /// Returns true if TxContentPoolRetires instances are equal
        /// </summary>
        /// <param name="input">Instance of TxContentPoolRetires to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxContentPoolRetires input)
        {
            if (input == null)
                return false;
