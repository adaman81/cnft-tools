...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TxMetadataLabelCbor : List<TxMetadataLabelCborInner>,  IEquatable<TxMetadataLabelCbor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxMetadataLabelCbor" /> class.
        /// </summary>
        public TxMetadataLabelCbor() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TxMetadataLabelCbor {\n");
        ...
        {
            return this.Equals(input as TxMetadataLabelCbor);
        }

        /// <summary>
        /// Returns true if TxMetadataLabelCbor instances are equal
        /// </summary>
        /// <param name="input">Instance of TxMetadataLabelCbor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxMetadataLabelCbor input)
        {
            if (input == null)
                return false;
