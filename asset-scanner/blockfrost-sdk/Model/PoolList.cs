...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PoolList : List<string>,  IEquatable<PoolList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolList" /> class.
        /// </summary>
        public PoolList() : base()
        {
        }
        ...
        {
            return this.Equals(input as PoolList);
        }

        /// <summary>
        /// Returns true if PoolList instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolList input)
        {
            if (input == null)
                return false;
