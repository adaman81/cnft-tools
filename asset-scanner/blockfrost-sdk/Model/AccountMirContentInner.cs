...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountMirContentInner :  IEquatable<AccountMirContentInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountMirContentInner" /> class.
        /// </summary>
        /// <param name="txHash">Hash of the transaction containing the MIR (required).</param>
        /// <param name="amount">MIR amount in Lovelaces (required).</param>
        public AccountMirContentInner(string txHash = default(string), string amount = default(string))
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new InvalidDataException("txHash is a required property for AccountMirContentInner and cannot be null");
            }
            else
            {
                this.TxHash = txHash;
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for AccountMirContentInner and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        /// </summary>
        /// <value>Hash of the transaction containing the MIR</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountMirContentInner {\n");
        ...
        {
            return this.Equals(input as AccountMirContentInner);
        }

        /// <summary>
        /// Returns true if AccountMirContentInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountMirContentInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountMirContentInner input)
        {
            if (input == null)
                return false;
