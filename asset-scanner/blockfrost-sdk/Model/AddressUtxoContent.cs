...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AddressUtxoContent : List<AddressUtxoContentInner>,  IEquatable<AddressUtxoContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressUtxoContent" /> class.
        /// </summary>
        public AddressUtxoContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressUtxoContent {\n");
        ...
        {
            return this.Equals(input as AddressUtxoContent);
        }

        /// <summary>
        /// Returns true if AddressUtxoContent instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressUtxoContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressUtxoContent input)
        {
            if (input == null)
                return false;
