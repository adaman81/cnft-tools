...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PoolRelays : List<PoolRelaysInner>,  IEquatable<PoolRelays>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolRelays" /> class.
        /// </summary>
        public PoolRelays() : base()
        {
        }
        ...
        {
            return this.Equals(input as PoolRelays);
        }

        /// <summary>
        /// Returns true if PoolRelays instances are equal
        /// </summary>
        /// <param name="input">Instance of PoolRelays to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoolRelays input)
        {
            if (input == null)
                return false;
