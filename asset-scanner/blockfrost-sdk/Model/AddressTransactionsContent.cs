...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AddressTransactionsContent : List<AddressTransactionsContentInner>,  IEquatable<AddressTransactionsContent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressTransactionsContent" /> class.
        /// </summary>
        public AddressTransactionsContent() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressTransactionsContent {\n");
        ...
        {
            return this.Equals(input as AddressTransactionsContent);
        }

        /// <summary>
        /// Returns true if AddressTransactionsContent instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressTransactionsContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressTransactionsContent input)
        {
            if (input == null)
                return false;
