...
namespace blockfrost.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponse425 :  IEquatable<InlineResponse425>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse425" /> class.
        /// </summary>
        /// <param name="statusCode">statusCode (required).</param>
        /// <param name="error">error (required).</param>
        /// <param name="message">message (required).</param>
        public InlineResponse425(int? statusCode = default(int?), string error = default(string), string message = default(string))
        {
            // to ensure "statusCode" is required (not null)
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for InlineResponse425 and cannot be null");
            }
            else
            {
            ...
            if (error == null)
            {
                throw new InvalidDataException("error is a required property for InlineResponse425 and cannot be null");
            }
            else
            {
                this.Error = error;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for InlineResponse425 and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse425 {\n");
        ...
        {
            return this.Equals(input as InlineResponse425);
        }

        /// <summary>
        /// Returns true if InlineResponse425 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse425 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse425 input)
        {
            if (input == null)
                return false;
